class StepperMeasRegs:
    ...
    STPMEAS_MODE = "STPMEAS_MODE"
    STPMEAS_TEMP_CALIB = "STPMEAS_TEMP_CALIB"
    STPMEAS_NTC_BETA = "STPMEAS_NTC_BETA"
    STPMEAS_NTC_STOCK_RES = "STPMEAS_NTC_STOCK_RES"
    STPMEAS_PT_STOCK_RES = "STPMEAS_PT_STOCK_RES"
    STPMEAS_RESISTANCE = "STPMEAS_RESISTANCE"
    STPMEAS_TEMPERATURE = "STPMEAS_TEMPERATURE"
