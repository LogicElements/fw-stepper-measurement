...
#define MODBUS_CLK_ENABLE()       do {__HAL_RCC_USART1_CLK_ENABLE();\
                                  } while(0)

#define MODBUS_TIMEOUT            10000

#define MODBUS_UART_INSTANCE      USART1              ///< MODBUS UART Instance
#define MODBUS_UART_IRQ_NUMBER    USART1_IRQn
#define MODBUS_UART_IRQ_HANDLER   USART1_IRQHandler
// změna
#define MODBUS_UART_ALTERNATE     GPIO_AF7_USART1     ///< MODBUS UART  Alternate function

#define MODBUS_UART_RX_PORT       GPIOA               ///< MODBUS UART Rx Pin
#define MODBUS_UART_RX_PIN        GPIO_PIN_10         ///< MODBUS UART Rx Port

#define MODBUS_UART_TX_PORT       GPIOA               ///< MODBUS UART Tx Pin
#define MODBUS_UART_TX_PIN        GPIO_PIN_9         ///< MODBUS UART Tx Port

#define MODBUS_UART_DE_PORT       GPIOA               ///< MODBUS UART DE Port
#define MODBUS_UART_DE_PIN        GPIO_PIN_12         ///< MODBUS UART DE Pin
